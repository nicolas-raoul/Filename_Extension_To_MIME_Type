...
public class MimeType {
     ...
     * @param fileName Relative filename, for instance mydoc.odt
     * @return MIME type, for instance application/vnd.oasis.opendocument.text
     */
